...
class oop{
    ...
    function tampil($table, $where, $cari){
        global $koneksi;
        $sql = mysqli_query($koneksi, "SELECT * FROM $table $where $cari");
        $jalan = array();
    ...
    function caridata($table){
        global $koneksi;
        $sql = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM $table"));
        return $sql;
    }

    function cekdata($table){
        global $koneksi;
        $sql = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM $table"));
        return $sql;
    }
    ...
    function login($table, $username, $password, $alamat){
        global $koneksi;
        session_start();
        $sql = mysqli_query($koneksi, "SELECT * FROM $table WHERE username = '" . mysqli_real_escape_string($koneksi, $username) . "' AND password = '" . mysqli_real_escape_string($koneksi, $password) . "'");
